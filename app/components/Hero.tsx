...
const Hero = () => {
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-[#000814]">
            {/* Odd Section: Navy Gaussian blobs */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="absolute inset-0 bg-orange-primary/10 blur-[100px] animate-pulse-slow"></div>
                        ...
                        <motion.div
                            ...
                            className="absolute -bottom-10 -left-10 glass-v2 px-6 py-4 rounded-2xl border-white/20 shadow-2xl"
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-xs text-white/40 font-bold uppercase tracking-widest">Growth</div>
