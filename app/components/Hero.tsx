...
const Hero = () => {
    return (
        <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-[#000814]">
            {/* Restored Gaussian Blurs */}
            ...
            <div className="gaussian-blur w-[300px] h-[300px] bg-orange-primary/20 top-[20%] right-[10%] opacity-20"></div>
            ...
            >
                <div className="max-w-5xl mx-auto glass-v2 rounded-[2rem] p-4 shadow-2xl relative">
                    <div className="absolute inset-0 bg-gradient-to-tr from-orange-primary/5 to-transparent rounded-[2rem]"></div>
                    <div className="bg-[#000D20] rounded-xl overflow-hidden aspect-[16/9] border border-white/5 flex items-center justify-center group p-8">
                        <div className="w-full h-full flex flex-col space-y-6">
                            <div className="flex space-x-4">
                                <div className="w-32 h-8 bg-white/5 rounded-md"></div>
                                <div className="w-24 h-8 bg-white/5 rounded-md"></div>
                            </div>
                            <div className="grid grid-cols-3 gap-6">
                                <div className="h-40 glass-v2 rounded-xl border border-white/10 flex flex-col items-center justify-center">
