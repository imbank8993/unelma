                ...
                <div className="glass-v2 border-white/5 rounded-[4rem] p-12 md:p-24 relative overflow-hidden group">
                    ...
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            ...
                            {/* Floating element */}
                            <div className="absolute -top-10 -right-10 w-40 h-40 glass-v2 border-orange-primary/20 rounded-full animate-float flex items-center justify-center">
                                <div className="text-orange-primary font-black text-5xl">100+</div>
                            </div>
                        </div>
                    </div>
                </div>
